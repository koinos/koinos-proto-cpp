...
#ifndef GOOGLE_PROTOBUF_INCLUDED_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto
...
struct TableStruct_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto;
namespace koinos {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::koinos::contract_meta_store::contract_meta_store_request* Arena::CreateMaybeMessage<::koinos::contract_meta_store::contract_meta_store_request>(Arena*);
template<> ::koinos::contract_meta_store::contract_meta_store_response* Arena::CreateMaybeMessage<::koinos::contract_meta_store::contract_meta_store_response>(Arena*);
template<> ::koinos::contract_meta_store::get_contract_meta_request* Arena::CreateMaybeMessage<::koinos::contract_meta_store::get_contract_meta_request>(Arena*);
template<> ::koinos::contract_meta_store::get_contract_meta_response* Arena::CreateMaybeMessage<::koinos::contract_meta_store::get_contract_meta_response>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace koinos {
namespace contract_meta_store {
...
class get_contract_meta_request final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:koinos.contract_meta_store.get_contract_meta_request) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "koinos.contract_meta_store.get_contract_meta_request";
  }
  protected:
 ...
 private:
  ...
  friend struct ::TableStruct_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto;
};
// -------------------------------------------------------------------

class get_contract_meta_response final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:koinos.contract_meta_store.get_contract_meta_response) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "koinos.contract_meta_store.get_contract_meta_response";
  }
  protected:
...
class contract_meta_store_request final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:koinos.contract_meta_store.contract_meta_store_request) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "koinos.contract_meta_store.contract_meta_store_request";
  }
  protected:
  ...
  const ::koinos::contract_meta_store::get_contract_meta_request& get_contract_meta() const;
  PROTOBUF_MUST_USE_RESULT ::koinos::contract_meta_store::get_contract_meta_request* release_get_contract_meta();
  ::koinos::contract_meta_store::get_contract_meta_request* mutable_get_contract_meta();
  void set_allocated_get_contract_meta(::koinos::contract_meta_store::get_contract_meta_request* get_contract_meta);
  private:
  const ::koinos::contract_meta_store::get_contract_meta_request& _internal_get_contract_meta() const;
  ::koinos::contract_meta_store::get_contract_meta_request* _internal_mutable_get_contract_meta();
  public:
  void unsafe_arena_set_allocated_get_contract_meta(
      ::koinos::contract_meta_store::get_contract_meta_request* get_contract_meta);
  ::koinos::contract_meta_store::get_contract_meta_request* unsafe_arena_release_get_contract_meta();
 ...
 private:
  ...
  union RequestUnion {
    ...
    ::koinos::contract_meta_store::get_contract_meta_request* get_contract_meta_;
  } request_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
class contract_meta_store_response final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:koinos.contract_meta_store.contract_meta_store_response) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "koinos.contract_meta_store.contract_meta_store_response";
  }
  protected:
  ...
  public:
  void clear_get_contract_meta();
  const ::koinos::contract_meta_store::get_contract_meta_response& get_contract_meta() const;
  PROTOBUF_MUST_USE_RESULT ::koinos::contract_meta_store::get_contract_meta_response* release_get_contract_meta();
  ::koinos::contract_meta_store::get_contract_meta_response* mutable_get_contract_meta();
  void set_allocated_get_contract_meta(::koinos::contract_meta_store::get_contract_meta_response* get_contract_meta);
  private:
  const ::koinos::contract_meta_store::get_contract_meta_response& _internal_get_contract_meta() const;
  ::koinos::contract_meta_store::get_contract_meta_response* _internal_mutable_get_contract_meta();
  public:
  void unsafe_arena_set_allocated_get_contract_meta(
      ::koinos::contract_meta_store::get_contract_meta_response* get_contract_meta);
  ::koinos::contract_meta_store::get_contract_meta_response* unsafe_arena_release_get_contract_meta();
 ...
 private:
  ...
  union ResponseUnion {
    ...
    ::koinos::contract_meta_store::get_contract_meta_response* get_contract_meta_;
  } response_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
inline const std::string& get_contract_meta_request::contract_id() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.get_contract_meta_request.contract_id)
...
void get_contract_meta_request::set_contract_id(ArgT0&& arg0, ArgT... args) {
 ...
 contract_id_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:koinos.contract_meta_store.get_contract_meta_request.contract_id)
}
inline std::string* get_contract_meta_request::mutable_contract_id() {
  std::string* _s = _internal_mutable_contract_id();
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.get_contract_meta_request.contract_id)
  return _s;
}
...
inline std::string* get_contract_meta_request::release_contract_id() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.get_contract_meta_request.contract_id)
...
inline void get_contract_meta_request::set_allocated_contract_id(std::string* contract_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:koinos.contract_meta_store.get_contract_meta_request.contract_id)
}
...
inline const ::koinos::contract_meta_store::contract_meta_item& get_contract_meta_response::meta() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.get_contract_meta_response.meta)
...
inline void get_contract_meta_response::unsafe_arena_set_allocated_meta(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:koinos.contract_meta_store.get_contract_meta_response.meta)
}
...
inline ::koinos::contract_meta_store::contract_meta_item* get_contract_meta_response::unsafe_arena_release_meta() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.get_contract_meta_response.meta)
...
inline ::koinos::contract_meta_store::contract_meta_item* get_contract_meta_response::mutable_meta() {
  ...
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.get_contract_meta_response.meta)
  return _msg;
}
inline void get_contract_meta_response::set_allocated_meta(::koinos::contract_meta_store::contract_meta_item* meta) {
  ...
  meta_ = meta;
  // @@protoc_insertion_point(field_set_allocated:koinos.contract_meta_store.get_contract_meta_response.meta)
}
...
inline ::koinos::reserved_rpc* contract_meta_store_request::release_reserved() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.contract_meta_store_request.reserved)
...
inline const ::koinos::reserved_rpc& contract_meta_store_request::_internal_reserved() const {
  return _internal_has_reserved()
      ? *request_.reserved_
      : reinterpret_cast< ::koinos::reserved_rpc&>(::koinos::_reserved_rpc_default_instance_);
}
inline const ::koinos::reserved_rpc& contract_meta_store_request::reserved() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.contract_meta_store_request.reserved)
  return _internal_reserved();
}
inline ::koinos::reserved_rpc* contract_meta_store_request::unsafe_arena_release_reserved() {
  // @@protoc_insertion_point(field_unsafe_arena_release:koinos.contract_meta_store.contract_meta_store_request.reserved)
  if (_internal_has_reserved()) {
    clear_has_request();
    ::koinos::reserved_rpc* temp = request_.reserved_;
    request_.reserved_ = nullptr;
...
inline void contract_meta_store_request::unsafe_arena_set_allocated_reserved(::koinos::reserved_rpc* reserved) {
  clear_request();
  if (reserved) {
    set_has_reserved();
    request_.reserved_ = reserved;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:koinos.contract_meta_store.contract_meta_store_request.reserved)
}
inline ::koinos::reserved_rpc* contract_meta_store_request::_internal_mutable_reserved() {
  if (!_internal_has_reserved()) {
    clear_request();
    set_has_reserved();
...
inline ::koinos::reserved_rpc* contract_meta_store_request::mutable_reserved() {
  ::koinos::reserved_rpc* _msg = _internal_mutable_reserved();
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.contract_meta_store_request.reserved)
  return _msg;
}
...
inline ::koinos::contract_meta_store::get_contract_meta_request* contract_meta_store_request::release_get_contract_meta() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.contract_meta_store_request.get_contract_meta)
  if (_internal_has_get_contract_meta()) {
    clear_has_request();
      ::koinos::contract_meta_store::get_contract_meta_request* temp = request_.get_contract_meta_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::koinos::contract_meta_store::get_contract_meta_request& contract_meta_store_request::_internal_get_contract_meta() const {
  return _internal_has_get_contract_meta()
      ? *request_.get_contract_meta_
      : reinterpret_cast< ::koinos::contract_meta_store::get_contract_meta_request&>(::koinos::contract_meta_store::_get_contract_meta_request_default_instance_);
}
inline const ::koinos::contract_meta_store::get_contract_meta_request& contract_meta_store_request::get_contract_meta() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.contract_meta_store_request.get_contract_meta)
  return _internal_get_contract_meta();
}
inline ::koinos::contract_meta_store::get_contract_meta_request* contract_meta_store_request::unsafe_arena_release_get_contract_meta() {
  // @@protoc_insertion_point(field_unsafe_arena_release:koinos.contract_meta_store.contract_meta_store_request.get_contract_meta)
  if (_internal_has_get_contract_meta()) {
    clear_has_request();
    ::koinos::contract_meta_store::get_contract_meta_request* temp = request_.get_contract_meta_;
    request_.get_contract_meta_ = nullptr;
...
inline void contract_meta_store_request::unsafe_arena_set_allocated_get_contract_meta(::koinos::contract_meta_store::get_contract_meta_request* get_contract_meta) {
  clear_request();
  if (get_contract_meta) {
    set_has_get_contract_meta();
    request_.get_contract_meta_ = get_contract_meta;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:koinos.contract_meta_store.contract_meta_store_request.get_contract_meta)
}
inline ::koinos::contract_meta_store::get_contract_meta_request* contract_meta_store_request::_internal_mutable_get_contract_meta() {
  if (!_internal_has_get_contract_meta()) {
    clear_request();
    set_has_get_contract_meta();
    request_.get_contract_meta_ = CreateMaybeMessage< ::koinos::contract_meta_store::get_contract_meta_request >(GetArenaForAllocation());
  }
  return request_.get_contract_meta_;
}
inline ::koinos::contract_meta_store::get_contract_meta_request* contract_meta_store_request::mutable_get_contract_meta() {
  ::koinos::contract_meta_store::get_contract_meta_request* _msg = _internal_mutable_get_contract_meta();
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.contract_meta_store_request.get_contract_meta)
  return _msg;
}
...
inline ::koinos::reserved_rpc* contract_meta_store_response::release_reserved() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.contract_meta_store_response.reserved)
  if (_internal_has_reserved()) {
    clear_has_response();
...
inline const ::koinos::reserved_rpc& contract_meta_store_response::_internal_reserved() const {
  return _internal_has_reserved()
      ? *response_.reserved_
      : reinterpret_cast< ::koinos::reserved_rpc&>(::koinos::_reserved_rpc_default_instance_);
}
inline const ::koinos::reserved_rpc& contract_meta_store_response::reserved() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.contract_meta_store_response.reserved)
  return _internal_reserved();
}
inline ::koinos::reserved_rpc* contract_meta_store_response::unsafe_arena_release_reserved() {
  // @@protoc_insertion_point(field_unsafe_arena_release:koinos.contract_meta_store.contract_meta_store_response.reserved)
  if (_internal_has_reserved()) {
    clear_has_response();
    ::koinos::reserved_rpc* temp = response_.reserved_;
    response_.reserved_ = nullptr;
...
inline void contract_meta_store_response::unsafe_arena_set_allocated_reserved(::koinos::reserved_rpc* reserved) {
  clear_response();
  if (reserved) {
    set_has_reserved();
    response_.reserved_ = reserved;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:koinos.contract_meta_store.contract_meta_store_response.reserved)
}
inline ::koinos::reserved_rpc* contract_meta_store_response::_internal_mutable_reserved() {
  if (!_internal_has_reserved()) {
    clear_response();
    set_has_reserved();
...
inline ::koinos::reserved_rpc* contract_meta_store_response::mutable_reserved() {
  ::koinos::reserved_rpc* _msg = _internal_mutable_reserved();
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.contract_meta_store_response.reserved)
  return _msg;
}
...
inline ::koinos::error_status* contract_meta_store_response::release_error() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.contract_meta_store_response.error)
...
inline const ::koinos::error_status& contract_meta_store_response::_internal_error() const {
  return _internal_has_error()
      ? *response_.error_
      : reinterpret_cast< ::koinos::error_status&>(::koinos::_error_status_default_instance_);
}
inline const ::koinos::error_status& contract_meta_store_response::error() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.contract_meta_store_response.error)
  return _internal_error();
}
inline ::koinos::error_status* contract_meta_store_response::unsafe_arena_release_error() {
  // @@protoc_insertion_point(field_unsafe_arena_release:koinos.contract_meta_store.contract_meta_store_response.error)
  if (_internal_has_error()) {
    clear_has_response();
    ::koinos::error_status* temp = response_.error_;
    response_.error_ = nullptr;
...
inline void contract_meta_store_response::unsafe_arena_set_allocated_error(::koinos::error_status* error) {
  clear_response();
  if (error) {
    set_has_error();
    response_.error_ = error;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:koinos.contract_meta_store.contract_meta_store_response.error)
}
inline ::koinos::error_status* contract_meta_store_response::_internal_mutable_error() {
  if (!_internal_has_error()) {
    clear_response();
    set_has_error();
...
inline ::koinos::error_status* contract_meta_store_response::mutable_error() {
  ::koinos::error_status* _msg = _internal_mutable_error();
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.contract_meta_store_response.error)
  return _msg;
}
...
inline ::koinos::contract_meta_store::get_contract_meta_response* contract_meta_store_response::release_get_contract_meta() {
  // @@protoc_insertion_point(field_release:koinos.contract_meta_store.contract_meta_store_response.get_contract_meta)
  if (_internal_has_get_contract_meta()) {
    clear_has_response();
      ::koinos::contract_meta_store::get_contract_meta_response* temp = response_.get_contract_meta_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::koinos::contract_meta_store::get_contract_meta_response& contract_meta_store_response::_internal_get_contract_meta() const {
  return _internal_has_get_contract_meta()
      ? *response_.get_contract_meta_
      : reinterpret_cast< ::koinos::contract_meta_store::get_contract_meta_response&>(::koinos::contract_meta_store::_get_contract_meta_response_default_instance_);
}
inline const ::koinos::contract_meta_store::get_contract_meta_response& contract_meta_store_response::get_contract_meta() const {
  // @@protoc_insertion_point(field_get:koinos.contract_meta_store.contract_meta_store_response.get_contract_meta)
  return _internal_get_contract_meta();
}
inline ::koinos::contract_meta_store::get_contract_meta_response* contract_meta_store_response::unsafe_arena_release_get_contract_meta() {
  // @@protoc_insertion_point(field_unsafe_arena_release:koinos.contract_meta_store.contract_meta_store_response.get_contract_meta)
  if (_internal_has_get_contract_meta()) {
    clear_has_response();
    ::koinos::contract_meta_store::get_contract_meta_response* temp = response_.get_contract_meta_;
    response_.get_contract_meta_ = nullptr;
...
inline void contract_meta_store_response::unsafe_arena_set_allocated_get_contract_meta(::koinos::contract_meta_store::get_contract_meta_response* get_contract_meta) {
  clear_response();
  if (get_contract_meta) {
    set_has_get_contract_meta();
    response_.get_contract_meta_ = get_contract_meta;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:koinos.contract_meta_store.contract_meta_store_response.get_contract_meta)
}
inline ::koinos::contract_meta_store::get_contract_meta_response* contract_meta_store_response::_internal_mutable_get_contract_meta() {
  if (!_internal_has_get_contract_meta()) {
    clear_response();
    set_has_get_contract_meta();
    response_.get_contract_meta_ = CreateMaybeMessage< ::koinos::contract_meta_store::get_contract_meta_response >(GetArenaForAllocation());
  }
  return response_.get_contract_meta_;
}
inline ::koinos::contract_meta_store::get_contract_meta_response* contract_meta_store_response::mutable_get_contract_meta() {
  ::koinos::contract_meta_store::get_contract_meta_response* _msg = _internal_mutable_get_contract_meta();
  // @@protoc_insertion_point(field_mutable:koinos.contract_meta_store.contract_meta_store_response.get_contract_meta)
  return _msg;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_koinos_2fcontract_5fmeta_5fstore_2frpc_2eproto
