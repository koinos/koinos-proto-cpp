...
class transaction_item PROTOBUF_FINAL :
 ...
 public:
  ...
  inline transaction_item* New() const final {
    return CreateMaybeMessage<transaction_item>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_koinos_2ftransaction_5fstore_2ftransaction_5fstore_2eproto);
    return ::descriptor_table_koinos_2ftransaction_5fstore_2ftransaction_5fstore_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline std::string* transaction_item::add_containing_blocks() {
  ...
  return _internal_add_containing_blocks();
}
