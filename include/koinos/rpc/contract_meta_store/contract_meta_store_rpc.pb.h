...
inline ::koinos::rpc::error_response* contract_meta_store_response::release_error() {
...
inline const ::koinos::rpc::error_response& contract_meta_store_response::_internal_error() const {
  return _internal_has_error()
      ? *response_.error_
      : reinterpret_cast< ::koinos::rpc::error_response&>(::koinos::rpc::_error_response_default_instance_);
}
inline const ::koinos::rpc::error_response& contract_meta_store_response::error() const {
  // @@protoc_insertion_point(field_get:koinos.rpc.contract_meta_store.contract_meta_store_response.error)
  return _internal_error();
}
inline ::koinos::rpc::error_response* contract_meta_store_response::unsafe_arena_release_error() {
...
inline void contract_meta_store_response::unsafe_arena_set_allocated_error(::koinos::rpc::error_response* error) {
  clear_response();
  if (error) {
    set_has_error();
...
inline ::koinos::rpc::error_response* contract_meta_store_response::_internal_mutable_error() {
  if (!_internal_has_error()) {
    clear_response();
    set_has_error();
...
inline ::koinos::rpc::error_response* contract_meta_store_response::mutable_error() {
