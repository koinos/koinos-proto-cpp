...
#ifndef GOOGLE_PROTOBUF_INCLUDED_koinos_2frpc_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_koinos_2frpc_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_koinos_2frpc_2eproto
...
struct TableStruct_koinos_2frpc_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_koinos_2frpc_2eproto;
namespace koinos {
class error_status;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::koinos::error_status* Arena::CreateMaybeMessage<::koinos::error_status>(Arena*);
template<> ::koinos::reserved_rpc* Arena::CreateMaybeMessage<::koinos::reserved_rpc>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace koinos {
...
class reserved_rpc final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:koinos.reserved_rpc) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_koinos_2frpc_2eproto;
};
// -------------------------------------------------------------------

class error_status final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:koinos.error_status) */ {
 public:
...
inline const std::string& error_status::message() const {
  // @@protoc_insertion_point(field_get:koinos.error_status.message)
...
void error_status::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:koinos.error_status.message)
}
inline std::string* error_status::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:koinos.error_status.message)
  return _s;
}
...
inline std::string* error_status::release_message() {
  // @@protoc_insertion_point(field_release:koinos.error_status.message)
...
inline void error_status::set_allocated_message(std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:koinos.error_status.message)
}
...
inline const std::string& error_status::data() const {
  // @@protoc_insertion_point(field_get:koinos.error_status.data)
...
void error_status::set_data(ArgT0&& arg0, ArgT... args) {
 ...
 data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:koinos.error_status.data)
}
inline std::string* error_status::mutable_data() {
  std::string* _s = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:koinos.error_status.data)
  return _s;
}
...
inline std::string* error_status::release_data() {
  // @@protoc_insertion_point(field_release:koinos.error_status.data)
...
inline void error_status::set_allocated_data(std::string* data) {
  ...
  data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:koinos.error_status.data)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 error_status::code() const {
  // @@protoc_insertion_point(field_get:koinos.error_status.code)
...
inline void error_status::set_code(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:koinos.error_status.code)
}
...
inline PROTOBUF_NAMESPACE_ID::Any* error_status::mutable_details(int index) {
  // @@protoc_insertion_point(field_mutable:koinos.error_status.details)
  return details_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< PROTOBUF_NAMESPACE_ID::Any >*
error_status::mutable_details() {
  // @@protoc_insertion_point(field_mutable_list:koinos.error_status.details)
  return &details_;
}
...
inline const PROTOBUF_NAMESPACE_ID::Any& error_status::details(int index) const {
  // @@protoc_insertion_point(field_get:koinos.error_status.details)
...
inline PROTOBUF_NAMESPACE_ID::Any* error_status::add_details() {
  ...
  // @@protoc_insertion_point(field_add:koinos.error_status.details)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< PROTOBUF_NAMESPACE_ID::Any >&
error_status::details() const {
  // @@protoc_insertion_point(field_list:koinos.error_status.details)
  return details_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_koinos_2frpc_2eproto
